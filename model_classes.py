...
class Critic(nn.Module):
    ...
    def __init__(self, input_size, output_size):
        ...
        self.scaling_factor_1 = 128
        self.scaling_factor_2 = 2048

        self.fc1 = nn.Linear(input_size, self.scaling_factor_1 * input_size)
        self.bn1 = nn.BatchNorm1d(self.scaling_factor_1 * input_size)
        self.fc2 = nn.Linear(self.scaling_factor_1 * input_size, self.scaling_factor_2 * output_size)
        self.bn2 = nn.BatchNorm1d(self.scaling_factor_2 * output_size)
        self.fc3 = nn.Linear(self.scaling_factor_2 * output_size, output_size)
